...
## Genome
# Call sites
#meRanCall -p 40 -o \$TMPDIR/ZJ_tmp/$1_Genome10xCall.txt -bam $2/result/$1/$1_meRanGh_genomeMapMerged_sorted.bam -f $GNM -mBQ 30 -gref -rl 150 -sc 10 -cr 1 -mr 0.00001 -mcov 10
#meRanCall -p 40 -o \$TMPDIR/ZJ_tmp/$1_Genome10xCall_3_Cutoff.txt -bam $2/result/$1/$1_meRanGh_genomeMapMerged_sorted.bam_3_Ccutoff_PE.bam -f $GNM -mBQ 30 -gref -rl 150 -sc 10 -cr 1 -mr 0.00001 -mcov 10
#meRanCall -p 40 -o \$TMPDIR/ZJ_tmp/$1_Genome10xCall_3_Cutoff_FDR.txt -bam $2/result/$1/$1_meRanGh_genomeMapMerged_sorted.bam_3_Ccutoff_PE.bam -f $GNM -mBQ 30 -gref -rl 150 -sc 10 -cr $GNconvrate -fdr 0.05 -mr 0.00001 -mcov 10
...
" > $1_meRanCallCutoffAnno.sbatch

sbatch $1_meRanCallCutoffAnno.sbatch
